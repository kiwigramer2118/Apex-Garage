...
import { events, getEventById, getTrackById, getUserById, EVENT_CATEGORY_LABEL } from "@/lib/data";
    ...
    <div className="pb-10">
      ...
      <div className="mx-auto max-w-2xl px-5 pt-5">
        ...
        {host && (
          <Link
            href="#"
            className="mt-4 flex items-center gap-3 rounded-card border border-border bg-surface-1 p-3"
          >
